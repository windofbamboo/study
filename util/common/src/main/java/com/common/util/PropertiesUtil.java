...
//		}
	...
	public static Properties getProperties(String name) {
		if (!CheckNull.isNull(name)) {
			...
			InputStream is = classLoaderUtil.getResourceAsStream(filename,PropertiesUtil.class.getClassLoader());
			...
			logger.info("url={}",classLoaderUtil.getResourceAsStream(filename,PropertiesUtil.class.getClassLoader()));
			try {
				properties.load(is);
				return properties;
