 ...
 * @author xue
 */
public class MdbBillUserSum2Sms implements Serializable, Cloneable {

  private static final Logger logger = LoggerFactory.getLogger(MdbBillUserSum2Sms.class);
  ...
  public MdbBillUserSum2Sms() {
  }

  public MdbBillUserSum2Sms(int cycleId, long ratePlanInsId, int billId, int day, long baseValue, long value, long roundValue, long moValue, long mtValue) {
  ...
  @Override
  public MdbBillUserSum2Sms clone() {
    MdbBillUserSum2Sms mdbBillUserSum2Sms = null;
    try {
      mdbBillUserSum2Sms = (MdbBillUserSum2Sms) super.clone();
    } catch (CloneNotSupportedException e) {
      logger.error(Arrays.toString(e.getStackTrace()));
    }
    return mdbBillUserSum2Sms;
  }
