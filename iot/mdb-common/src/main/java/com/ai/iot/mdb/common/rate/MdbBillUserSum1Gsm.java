 ...
 * @author xue
 */
public class MdbBillUserSum1Gsm implements Serializable, Cloneable {

  private static final Logger logger = LoggerFactory.getLogger(MdbBillUserSum1Gsm.class);
  ...
  public MdbBillUserSum1Gsm() {
  }

  public MdbBillUserSum1Gsm(long ratePlanInsId, int billId, int day, long value, long roundValue, long moValue, long mtValue) {
  ...
  @Override
  public MdbBillUserSum1Gsm clone() {
    MdbBillUserSum1Gsm mdbBillUserSum1Gsm = null;
    try {
      mdbBillUserSum1Gsm = (MdbBillUserSum1Gsm) super.clone();
    } catch (CloneNotSupportedException e) {
      logger.error(Arrays.toString(e.getStackTrace()));
    }
    return mdbBillUserSum1Gsm;
  }
